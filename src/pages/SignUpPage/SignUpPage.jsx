...
export default function SignUpPage(props) {
    ...
    return <>
        ...
        <form className="m-8 flex place-content-center" onSubmit={handleSubmit}>
            <fieldset className="[&>*]:m-2 [&>input]:disabled:text-slate-200 border-solid border-2 flex flex-col place-content-center place-items-center w-1/3 rounded-xl p-8" disabled={formState === "loading"}>
